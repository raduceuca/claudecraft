      ...
      <article className="max-w-xl mx-auto px-6 py-20">
        ...
        <header className="mb-20">
          ...
          <p className="text-base-content/70 text-pretty">
            ...
            A designer-first boilerplate for building non-slop with Claude Code.
          </p>
        </header>
        ...
        <section className="mb-20">
          ...
          {/* Bun installation */}
          <div className="bg-base-200 rounded-lg p-4 my-8">
            <p className="text-sm text-base-content/80 mb-3">
              <strong>You'll need Bun.</strong> It runs your code.
              Paste this in Terminal (Mac) or WSL (Windows):
            </p>
  ...
  "permissions": {
    "allow": [
      ...
      "Bash(ls:*)"
        ...
        {/* Skills */}
        <section className="mb-20">
          <h2 className="text-lg font-semibold mb-4 text-balance">10 Skills Included</h2>
          <p className="text-base-content/70 mb-6 text-pretty">
            Skills are instructions Claude follows. These ones are designer-friendly.
          </p>
          ...
          <div className="space-y-3 text-sm">
            <div className="flex justify-between items-baseline">
              <span className="text-base-content/80">
                ...
                <a href="https://github.com/obra/superpowers" target="_blank" rel="noopener noreferrer" className="text-base-content/40 hover:text-primary ml-2 text-xs">
                  via obra
                </a>
              </span>
              <span className="text-base-content/50">find bugs methodically</span>
            </div>
            ...
            <div className="flex justify-between items-baseline">
              ...
              <span className="text-base-content/50">write tests that matter</span>
            </div>
            ...
            <div className="flex justify-between items-baseline">
              ...
              <span className="text-base-content/50">avoid performance traps</span>
            </div>
            ...
            <div className="flex justify-between items-baseline">
              ...
              <span className="text-base-content/50">modern CSS patterns</span>
            </div>

            <div className="flex justify-between items-baseline">
              <span className="text-base-content/80">seo-review</span>
              <span className="text-base-content/50">check meta, OG, headings</span>
            </div>
            ...
            <div className="flex justify-between items-baseline">
              ...
              <span className="text-base-content/50">WCAG 2.1 AA checklist</span>
            </div>

            <div className="flex justify-between items-baseline">
              <span className="text-base-content/80">og-image</span>
              <span className="text-base-content/50">social sharing images</span>
            </div>

            <div className="flex justify-between items-baseline">
              <span className="text-base-content/80">microcopy</span>
              <span className="text-base-content/50">buttons, errors, states</span>
            </div>

            <div className="flex justify-between items-baseline">
              <span className="text-base-content/80">sitemap-generator</span>
              <span className="text-base-content/50">XML sitemap + robots</span>
            </div>

            <div className="flex justify-between items-baseline">
              <span className="text-base-content/80">json-ld</span>
              <span className="text-base-content/50">structured data</span>
            </div>
          </div>
        </section>
...
├── skills/             # debugging, testing, react, ui
