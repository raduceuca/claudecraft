    ...
    <div className="min-h-dvh bg-base-100 text-base-content">
      <article className="max-w-3xl mx-auto px-6 py-20">
        ...
        <header className="mb-20 max-w-xl">
          <h1 className="sr-only">claudecraft — Designer-first boilerplate for Claude Code</h1>
          ...
          <p className="text-lg text-base-content/70 leading-relaxed mb-6">
            Your job isn't going anywhere—but it is getting weirder.
          </p>

          <p className="text-lg text-base-content/70 leading-relaxed mb-8">
            The robots are here. They have opinions about border-radius.
          </p>

          <div className="w-12 h-px bg-base-content/20 mb-8" aria-hidden="true" />

          <p className="text-lg text-base-content/70 leading-relaxed mb-6">
            This is a boilerplate for people who'd rather shape the slop than become it.
          </p>

          <p className="text-lg text-base-content/60 leading-relaxed">
            Pre-configured with design constraints, accessibility guilt trips, and 32 themes so you can procrastinate on the hard decisions.
          </p>
        ...
        <section className="mb-20 max-w-xl">
          <h2 className="text-lg font-semibold mb-6 text-balance text-base-content">Get Started</h2>

          {/* CLI install - primary method */}
          ...
          {/* Also works with */}
          <p className="text-sm text-base-content/50 mt-4 mb-2">
            Also works with npm/pnpm:
          </p>
          <div className="space-y-2">
            <CopyCommand>npx create-claudecraft my-app</CopyCommand>
            <CopyCommand>pnpm create claudecraft my-app</CopyCommand>
          </div>

          {/* Bun installation - hand-drawn style */}
          <div
            className="relative my-12 p-5 pt-8 border-2 border-dashed border-base-content/25 bg-base-200/30"
            style={{
              borderRadius: '16px 8px 12px 20px',
            }}
          >
            {/* Handwritten title overlapping corner */}
            <h3
              className="absolute -top-5 -left-2 text-4xl text-primary font-semibold px-2 bg-base-100"
              style={{
          ...
          {/* Run it */}
          <p className="text-sm font-medium mb-3">Then:</p>
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              <CopyCommand>cd my-app && bun dev</CopyCommand>
              <span className="text-sm text-base-content/50">starts the server</span>
            </div>
          </div>
          <p className="text-sm text-base-content/50 mt-4">
            Open <code className="font-mono text-primary">localhost:6969</code>. Nice.
          </p>
          ...
          <p className="text-sm text-base-content/40 mt-6">
            ...
            {' '}or{' '}
            <code className="text-sm">git clone https://github.com/raduceuca/claudecraft</code>
          </p>
        </section>
        ...
        {/* Stack */}
        <section className="mb-20 max-w-xl">
          <h2 className="text-lg font-semibold mb-6 text-balance text-base-content">Stack</h2>
          <div className="grid grid-cols-4 gap-4">
            ...
            <div className="flex flex-col items-center gap-2 transition-transform hover:scale-110">
              ...
              <span className="text-sm text-base-content/70">React</span>
            </div>
            {/* TypeScript */}
            <div className="flex flex-col items-center gap-2 transition-transform hover:scale-110">
              <svg className="size-8 text-base-content/70" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <span className="text-sm text-base-content/70">TypeScript</span>
            </div>
            {/* Vite */}
            <div className="flex flex-col items-center gap-2 transition-transform hover:scale-110">
              <svg className="size-8 text-base-content/70" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <span className="text-sm text-base-content/70">Vite</span>
            </div>
            {/* Tailwind */}
            <div className="flex flex-col items-center gap-2 transition-transform hover:scale-110">
              <svg className="size-8 text-base-content/70" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <span className="text-sm text-base-content/70">Tailwind</span>
            </div>
            {/* DaisyUI */}
            <div className="flex flex-col items-center gap-2 transition-transform hover:scale-110">
              <svg className="size-8 text-base-content/70" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <span className="text-sm text-base-content/70">DaisyUI</span>
            </div>
            {/* Vitest */}
            <div className="flex flex-col items-center gap-2 transition-transform hover:scale-110">
              <svg className="size-8 text-base-content/70" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <span className="text-sm text-base-content/70">Vitest</span>
            </div>
            {/* Testing Library */}
            <div className="flex flex-col items-center gap-2 transition-transform hover:scale-110">
              <svg className="size-8 text-base-content/70" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <span className="text-sm text-base-content/70">RTL</span>
            </div>
            {/* Bun */}
            <div className="flex flex-col items-center gap-2 transition-transform hover:scale-110">
              <svg className="size-8 text-base-content/70" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <span className="text-sm text-base-content/70">Bun</span>
            </div>
          </div>
        </section>
        ...
        {/* What's Inside */}
        <section className="mb-20 max-w-xl">
          <h2 className="text-lg font-semibold mb-4 text-balance text-base-content">What's Inside</h2>
...
- Suggested fix if obvious`}
  ...
  "permissions": {
    "allow": [
      ...
      "Bash(ls:*)"
        ...
        {/* Commands */}
        <section className="mb-20 max-w-xl">
          <h2 className="text-lg font-semibold mb-4 text-balance text-base-content">7 Commands</h2>
          <p className="text-base-content/70 mb-6 text-pretty">
          ...
          <div className="space-y-3 text-sm">
            <div className="flex items-baseline gap-2">
              ...
              <span className="flex-1 border-b border-dotted border-base-content/20" aria-hidden="true"></span>
              <span className="flex-1 border-b border-dotted border-base-content/15" aria-hidden="true"></span>
        ...
        {/* Skills */}
        <section className="mb-20 max-w-xl">
          <h2 className="text-lg font-semibold mb-4 text-balance text-base-content">27 Skills Included</h2>
          <p className="text-base-content/70 mb-6 text-pretty">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-baseline gap-2">
              <span className="text-base-content/80">
                ...
                <a href="https://vercel.com/design/guidelines" target="_blank" rel="noopener noreferrer" className="text-base-content/40 hover:text-primary ml-2 text-sm" onClick={trackLink('link_vercel')}>
                  via Vercel
                </a>
              </span>
              <span className="flex-1 border-b border-dotted border-base-content/15" aria-hidden="true"></span>
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-base-content/80">
                testing-patterns
                <a href="https://github.com/ChrisWiles/claude-code-showcase" target="_blank" rel="noopener noreferrer" className="text-base-content/40 hover:text-primary ml-2 text-sm" onClick={trackLink('link_chriswiles')}>
                  via ChrisWiles
                </a>
              </span>
              <span className="flex-1 border-b border-dotted border-base-content/15" aria-hidden="true"></span>
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-base-content/80">
                ui-skills
                <a href="https://www.ui-skills.com/" target="_blank" rel="noopener noreferrer" className="text-base-content/40 hover:text-primary ml-2 text-sm" onClick={trackLink('link_uiskills')}>
                  via ui-skills.com
                </a>
              </span>
              <span className="flex-1 border-b border-dotted border-base-content/15" aria-hidden="true"></span>
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-base-content/80">
                a11y-audit
                <a href="https://claude-plugins.dev/skills/@daffy0208/ai-dev-standards/accessibility-engineer" target="_blank" rel="noopener noreferrer" className="text-base-content/40 hover:text-primary ml-2 text-sm" onClick={trackLink('link_daffy0208')}>
                  via daffy0208
                </a>
              </span>
              <span className="flex-1 border-b border-dotted border-base-content/15" aria-hidden="true"></span>
        ...
        {/* Ralph Wiggum */}
        <section className="mb-20 max-w-xl">
          <h2 className="text-lg font-semibold mb-4 text-balance text-base-content">The Superpower: Ralph Loops</h2>
          <p className="text-base-content/70 mb-6 text-pretty">
  ...
  --max-iterations 15`}</CodeBlock>
        ...
        {/* UI */}
        <section className="mb-20 max-w-xl">
          <h2 className="text-lg font-semibold mb-4 text-balance text-base-content">32 Themes</h2>
          <p className="text-base-content/70 mb-6 text-pretty">
        ...
        {/* Designer Resources */}
        <section className="mb-20 max-w-xl">
          <h2 className="text-lg font-semibold mb-4 text-balance text-base-content">Designer Resources</h2>
          <p className="text-base-content/70 mb-6 text-pretty">
            Visual references and guidelines for building with Claude Code.
          </p>
          <div className="grid gap-4 md:grid-cols-2">
            <Link
              to="/components"
              className="card bg-base-200 hover:bg-base-300 transition-colors"
              onClick={trackLink('link_components')}
            >
              <div className="card-body p-4">
                <h3 className="card-title text-base">Component Showcase</h3>
                <p className="text-sm text-base-content/60">
                  Visual gallery of all available DaisyUI components with copy-paste code.
                </p>
              </div>
            </Link>
            <Link
              to="/patterns"
              className="card bg-base-200 hover:bg-base-300 transition-colors"
              onClick={trackLink('link_patterns')}
            >
              <div className="card-body p-4">
                <h3 className="card-title text-base">Design Patterns</h3>
                <p className="text-sm text-base-content/60">
                  When to use what, spacing guidelines, and do/don't examples.
                </p>
              </div>
            </Link>
          </div>
          <p className="text-sm text-base-content/40 mt-4">
            Use <code className="font-mono text-primary">/design</code> or <code className="font-mono text-primary">/theme</code> skills for AI-assisted design help.
          </p>
        </section>
        ...
        {/* Structure */}
        <section className="mb-20 max-w-xl">
          <h2 className="text-lg font-semibold mb-6 text-balance text-base-content">Structure</h2>
          <CodeBlock>{`.claude/
├── commands/           # /build, /lint, /ralph, etc.
├── hooks/              # typecheck-after-edit, check-branch
├── skills/             # 27 skills for keeping Claude in line
...
CLAUDE.md               # project context`}</CodeBlock>
        ...
        {/* Why */}
        <section className="mb-20 max-w-xl">
          <h2 className="text-lg font-semibold mb-6 text-balance text-base-content">Why</h2>
